...
class Implementacao {
    protected:
        /**
         * @brief Indica se o grafo é direcionado.
         */
        bool direcionado;

        /**
         * @brief Indica se o grafo é ponderado.
         */
        bool ponderado;
    ...
    public:
        ...
        /**
         * @brief Exibe a representação do grafo utilizando rótulos personalizados para os vértices.
